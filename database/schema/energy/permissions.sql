...
SELECT * FROM public.grant_schema_permissions ('energy', ARRAY['SELECT'], 'totus');
...
SELECT * FROM public.grant_schema_permissions ('energy', ARRAY['SELECT', 'INSERT'], 'totus_ingester');
