...
SELECT * FROM public.grant_schema_permissions ('trafficmodel', ARRAY['SELECT'], 'totus');
...
SELECT * FROM public.grant_schema_permissions ('trafficmodel', ARRAY['SELECT', 'INSERT'], 'totus_ingester');
