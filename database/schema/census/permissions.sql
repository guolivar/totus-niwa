...
SELECT * FROM public.grant_schema_permissions ('census', ARRAY['SELECT'], 'totus');
...
SELECT * FROM public.grant_schema_permissions ('census', ARRAY['SELECT', 'INSERT'], 'totus_ingester');
