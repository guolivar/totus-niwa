...
SELECT * FROM public.grant_schema_permissions ('network', ARRAY['SELECT'], 'totus');
...
SELECT * FROM public.grant_schema_permissions ('network', ARRAY['SELECT', 'INSERT'], 'totus_ingester');
