...
SELECT * FROM public.grant_schema_permissions ('exposure', ARRAY['SELECT'], 'totus');
...
SELECT * FROM public.grant_schema_permissions ('exposure', ARRAY['SELECT', 'INSERT'], 'totus_ingester');
