...
class WKT(Format):
    ...
    def encode(self, features, **kwargs):
        ...
        for feature in features:
            results.append( self.to_wkt(feature.geometry))
...
def to_wkt (geom):
    ...
    if geom["type"] == "Point":
        ...
        raise Exception("Couldn't create WKT from geometry of type %s (%s). Only Point, (Multi)Line, (Multi)Polygon are supported." % (geom['type'], geom))
